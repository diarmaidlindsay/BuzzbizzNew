...
public class SampleDataUtil {
    ...
    static final String[] SAMPLE_CONTACTS_EN =  {"Tomkiewicz","Zigomalas","Andrade","Mcwalters","Veness","Rampy","Grasmick","Hisaw","Manzella",
    ...
    public static List<ContactListItem> getSampleContacts() {
        ...
        for(int i = 0; i < SAMPLE_CONTACTS_JP.length; i++) {
            sampleContacts.put(sampleNumbers.get(i), new ContactListItem(sampleNumbers.get(i), SAMPLE_CONTACTS_JP[i]));
        }
